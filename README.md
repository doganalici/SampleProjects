...
| **InterfaceSimpleBankingSystem** | arklı bankalar (Ziraat, VakıfBank, Garanti) için ortak işlemleri (Deposit, Withdraw, CheckBalance) tanımlayan bir IBankService arayüzü içerir.<br>Toplam harcama: Platform bazında yapılan toplam harcama hesaplanır.<br>Son |
